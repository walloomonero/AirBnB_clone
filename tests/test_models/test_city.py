...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        my_city = City()
        my_city.id = "123456"
        my_city.created_at = my_city.updated_at = dt
        my_city_str = my_city.__str__()
        self.assertIn("[City] (123456)", my_city_str)
        self.assertIn("'id': '123456'", my_city_str)
        self.assertIn("'created_at': " + dt_repr, my_city_str)
        self.assertIn("'updated_at': " + dt_repr, my_city_str)
...
class TestCity_save(unittest.TestCase):
    """Unittests to test the save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests to test the to_dict method of the City class."""
