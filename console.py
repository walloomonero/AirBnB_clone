...
class HBNBCommand(cmd.Cmd):
    """To defines the HolbertonBnB command interpreter.
    ...
    def do_create(self, arg):
        """Usage: create <class>
        To create a new class instance and print its id.
        """
        argl = parse(arg)
        if len(argl) == 0:
    ...
    def do_show(self, arg):
        ...
        To display the string representation of a class instance of a given id.
        """
        argl = parse(arg)
        objdict = storage.all()
        if len(argl) == 0:
    ...
    def do_all(self, arg):
        ...
        To deisplay string representations of all instances of a given class.
